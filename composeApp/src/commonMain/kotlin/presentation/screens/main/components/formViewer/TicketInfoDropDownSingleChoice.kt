...
@Composable
fun TicketInfoDropDownSingleChoice(
    readOnly: Boolean,
    disable: Boolean,
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            MaterialTheme(shapes = MaterialTheme.shapes.copy(extraSmall = RoundedCornerShape(10.dp))) {
                DropdownMenu(
                    ...
                    modifier = Modifier
                        .border(1.dp, strokeDefaultLight, RoundedCornerShape(10.dp))
                    ...
                    Row(
                        ...
                        TextField(
                            ...
                            modifier = Modifier
                                .height(48.dp)
                                .fillMaxWidth()
                                .border(1.dp, strokeDefaultLight, RoundedCornerShape(8.dp)),
                            textStyle = TextStyle(
                                color = textSecondary,
                                fontSize = 14.sp
                            ),
