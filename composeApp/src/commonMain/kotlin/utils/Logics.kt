...
class LogicCalculation(
    ...
    suspend fun extractTicketAutoFillLogics(
...
//
            when {
                it.logicType == LogicType.Ticket_Auto_Fill -> {
                                                            ...
                                                            result.data[key]?.let { resultData ->
                                                                ...
                                                                if (resultData.isNotEmpty()) {
                                                                    withContext(Dispatchers.Main) {
                                                                        Napier.log(
                                                                            LogLevel.ASSERT,
                                                                            tag = "extractTicketAutoFillLogics",
                                                                            message = resultData
                                                                        )
                                                                    }
                                                                    ...
                                                                    withContext(Dispatchers.Main) {
                                                                        Napier.log(
                                                                            LogLevel.ASSERT,
                                                                            tag = "updatedValueDomain label",
                                                                            message = component.label.toString()
                                                                        )

                                                                        Napier.log(
                                                                            LogLevel.ASSERT,
                                                                            tag = "updatedValueDomain calculatedValue",
                                                                            message = component.processLogicDomain.value.calculatedValue.toString()
                                                                        )
                                                                    }
...
suspend fun extractLogics(
    components: List<ComponentDomain>,
    component: ComponentDomain
): MutableList<ExtractLogicsModel> {
    var hasLogic = false
    var typeLogic = ""
    var idCmp = ""
    component.logics?.forEach { it ->
