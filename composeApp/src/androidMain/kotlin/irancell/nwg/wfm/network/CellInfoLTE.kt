...
@Serializable
data class CellInfoLTE(val ci: Int, val pci: Int, val tac: Int, val mcc: Int, val mnc: Int, val erfcn : Int,val bandwidth : Int?,val mobileNetworkOperator: String,val cellSignalStrengthLTE: CellSignalStrengthLTE ) : CellInfo()
@Serializable
