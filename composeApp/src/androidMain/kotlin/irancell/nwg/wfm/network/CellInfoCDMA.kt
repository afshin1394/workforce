...
@Serializable
data class CellInfoCDMA(val baseStationId: Int, val latitude: Int, val longitude: Int, val networkId: Int, val systemId: Int, val signalStrength: Int,val cellSignalStrengthCDMA: CellSignalStrengthCDMA) : CellInfo()
@Serializable
